...
data "null_data_source" "local_vars" {
  inputs = {
    ...
    { 'storageAccountName': '${azurerm_storage_account.testenvstorageaccount.name}', 'storageAccountKey': '${azurerm_storage_account.testenvstorageaccount.primary_access_key}'}
SETTINGS
